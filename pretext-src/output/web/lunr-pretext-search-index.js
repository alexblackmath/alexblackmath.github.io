...
},
{
  ...
  "number": "2.2",
  "title": "",
  "body": "  Let be a vector space, and let be a linearly independent subset of . Then for any , is linearly independent.    Suppose not. Then there exists a linearly independent set and such that is linearly dependent. Then in particular, there exist and not all zero such that   Since are linearly independent, one cannot have . Thus, by moving everything other than to one side, we find that   Since , we may divide by it on both sides to find   But then, by definition, .   "
},
{
  "id": "exercise-1",
  "level": "2",
